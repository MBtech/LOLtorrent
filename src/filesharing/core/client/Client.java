...
public class Client {
	 ...
	 */
	private List<TrackerInformation> tracker_list = new ArrayList<TrackerInformation>();
	 ...
	 * @throws IOException
	 */
	private void addFile(String filename, File file, Collection<TrackerInformation> trackers) throws IOException {
	 ...
	 * @throws IOException 
	 */
	public void downloadFile(String filename, Collection<TrackerInformation> trackers) throws IOException {
	 ...
	 * @throws IOException 
	 */
	public void seedFile(String path, int block_size, Collection<TrackerInformation> trackers) throws IOException {
		// initialize stuff
